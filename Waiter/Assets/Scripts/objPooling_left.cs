...
public class objPooling_left : MonoBehaviour
{

    public static objPooling_left Instance;
    ...
    public GameObject GetPooledObject(int objectType)
    {
        ...
        pltpickuptest.Instance.cubeObjects_left.Add(obj);


        if (pltpickuptest.Instance.cubeObjects_left.Count == 1) //left empty objecti listenin içindedir..(değil artık...!!!!!).
        {
            ...
            dequeuedLeftObjectPosition = new Vector3(obj.transform.position.x,
                pltpickuptest.Instance.stackEmptyPos_left.y,obj.transform.position.z);
            ...
            obj.gameObject.GetComponent<pltfllowertest>().startEqualposit(pltpickuptest.Instance.stackemptyobjPTransform_left, true);
        ...
        {
            obj.gameObject.transform.position = dequeuedLeftObjectPosition;
            dequeuedLeftObjectPosition = new Vector3(obj.transform.position.x, obj.transform.position.y + 1,
                obj.transform.position.z);
            obj.gameObject.GetComponent<pltfllowertest>().followlastcubepos(pltpickuptest.Instance.cubeObjects_left[pltpickuptest.Instance.left_cubeListIndexCounter].transform,true); //listenin veya stackin üstündeki en üstteki objenin transformu
            pltpickuptest.Instance.left_cubeListIndexCounter++;
