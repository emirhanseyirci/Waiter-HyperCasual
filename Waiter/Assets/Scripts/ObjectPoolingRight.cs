...
public class ObjectPoolingRight : MonoBehaviour
{
    ...
    //public static ObjectPoolingRight Instance;
    ...
    //    PlatePickUpRight.Instance.cubeObjects_left.Add(obj);


    //    if (PlatePickUpRight.Instance.cubeObjects_left.Count == 1) //left empty objecti listenin içindedir..(değil artık...!!!!!).
    //    {
    ...
    //            PlatePickUpRight.Instance.stackEmptyPos_left.y, obj.transform.position.z);
    ...
    //        obj.gameObject.GetComponent<PlateFollowerRight>().startEqualposit(PlatePickUpRight.Instance.stackemptyobjPTransform_left, true);
    ...
    //    }
    //    else if (PlatePickUpRight.Instance.cubeObjects_left.Count > 1)
    //    {
    //        obj.gameObject.transform.position = dequeuedRightObjectPosition;
    //        dequeuedRightObjectPosition = new Vector3(obj.transform.position.x, obj.transform.position.y + 1,
    //            obj.transform.position.z);
    //        obj.gameObject.GetComponent<PlateFollowerRight>().followLastCubePos(PlatePickUpRight.Instance.cubeObjects_left[PlatePickUpRight.Instance.left_cubeListIndexCounter].transform, true); //listenin veya stackin üstündeki en üstteki objenin transformu
    //        PlatePickUpRight.Instance.left_cubeListIndexCounter++;
